 ...
 * SVG repository
 *
 * Central storage for raw SVG icons.
 *
...
class Svg_Repository {
	...
	/**
	 * Add or override an icon at runtime.
	 *
	 * @param string $name Icon key.
	 * @param string $svg  Raw svg markup.
	 * @return void
	 */
	public static function set( $name, $svg ) {
		self::$icons[ $name ] = $svg;
	}
}
