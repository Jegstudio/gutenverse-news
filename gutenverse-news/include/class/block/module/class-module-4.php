...
class Module_4 extends Module_View_Abstract {
	 ...
	 * @var string
	 */
	public $main_thumbnail_class = 'gvnews_pl_md_3';
	...
	public function build_column( $results, $column_class, $is_ajax ) {
		...
		for ( $i = 0; $i < $size; $i++ ) {
			$first_block .= $this->render_block_type_1( apply_filters( 'gvnews_module_query_results', $results['result'], $this->attribute ), $image_size );
		}
