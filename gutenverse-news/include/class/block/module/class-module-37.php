 ...
 * @author Jegstudio
 */
class Module_37 extends Module_View_Abstract {
	 ...
	 * @var string
	 */
	public $main_thumbnail_class = 'thumbnail-container';
	...
	public function build_column( $results ) {
		...
		$size        = count( $results );
		for ( $i = 0; $i < $size; $i++ ) {
			$first_block .= $this->render_block_type_1( $results[ $i ], 'gvnews-1140x815' );
		}
