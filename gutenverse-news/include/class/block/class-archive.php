...
class Archive extends Grab {
	...
	public function check_deprecated() {
		if ( current_user_can( 'edit_pages' ) && ( 'GUTENVERSE\NEWS\Block\Archive\Archive_Hero' === $this->attributes['gvnewsModule'] || 'GUTENVERSE\NEWS\Block\Archive\Archive_Title' === $this->attributes['gvnewsModule'] ) ) {
			return true;
		}
		return false;
	}
