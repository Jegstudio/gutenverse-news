...
class Blocks {
	...
	public function block_category( $categories ) {
		...
		// $categories['gvnews-carousel'] = __( 'Gutenverse News Carousel', 'gutenverse-news' ); this caregory is removed because all block on this category is deprecated, will added on feature.
