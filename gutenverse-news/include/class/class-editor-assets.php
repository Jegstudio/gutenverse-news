...
class Editor_Assets {
	...
	public function enqueue_scripts() {
		...
		$block[] = 'gvnews-frontend-hero-slider-script';
		$block[] = 'gvnews-frontend-carousel-slider-script';
		$block[] = 'gvnews-frontend-slider-script';
		$block[] = 'gvnews-frontend-newsticker-script';
