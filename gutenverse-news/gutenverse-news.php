...
defined( 'GUTENVERSE_NEWS_VERSION' ) || define( 'GUTENVERSE_NEWS_VERSION', '3.0.3-dev' );
defined( 'GUTENVERSE_NEWS_NOTICE_VERSION' ) || define( 'GUTENVERSE_NEWS_NOTICE_VERSION', '3.0.0' );
...
defined( 'GUTENVERSE_NEWS_REQUIRED_PRO_VERSION' ) || define( 'GUTENVERSE_REQUIRED_PRO_VERSION', '2.0.0' );
