...
const Hero10Block = compose(
    ...
    const blockProps = useBlockProps({
        className: classnames('gvnews-block',
            'gvnews-block-wrapper', 'gvnews-hero-10', elementId, animationClass, displayClass),
        ref: elementRef,
    });
