...
import { advancePanel, backgroundPanel, borderPanel, responsivePanel, animationPanel, conditionPanel } from 'gutenverse-core/controls';
        ...
        [
            ...
            },
            {
                ...
                panelArray: (props) => postItemGridPanel({
                    ...props,
                    mainContent: '.gvnews_postbig > .gvnews_post'
                }),
                tabRole: TabStyle
            },
            {
