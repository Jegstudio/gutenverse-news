...
const Hero12Block = compose(
    ...
    const blockProps = useBlockProps({
        className: classnames('gvnews-block',
            'gvnews-block-wrapper', 'gvnews-hero-12', elementId, animationClass, displayClass),
        ref: elementRef,
    });

    return (
        <>
            <PanelDeprecated title="Hero 12" />
            <div {...blockProps}>
