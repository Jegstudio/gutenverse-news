...
const Slider4Block = compose(
    ...
    function RenderColumn(props) {
        ...
        return (
            <div className="gvnews_slider_type_4 gvnews_slider" data-autoplay={autoplay ? true : ''} data-delay={autoplayDelay}>
                {content}
            </div>
        );
    }
    ...
    function resetblock() {
        setBlock(
            <div className={'gvnews_slider_wrapper gvnews_slider_type_4_wrapper gvnews_owlslider'}>
