...
const Block37Block = compose(
    ...
    const blockProps = useBlockProps({
        className: classnames('gvnews-block',
            'gvnews-block-wrapper', 'gvnews-block-37', elementId, animationClass, displayClass),
        ref: blockStyleRef
    });
        ...
        <>
            ...
            <div {...blockProps}>
                <div className="gvnews-raw-wrapper gvnews-editor">
                    <div
                        className={`gvnews_postblock_37 gvnews_postblock gvnews_module_hook gvnews_col_${blockWidth == 4 ? '1' : blockWidth == 8 ? '2' : '3'}o3 ${enableBoxed ? 'gvnews_pb_boxed' : ''
