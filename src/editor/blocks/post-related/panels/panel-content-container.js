...
export const contentContainerPanel = (props) => {
    ...
    const contentAlignVertical = {
        main: ['template_2', 'template_3', 'template_4', 'template_5', 'template_6', 'template_7', 'template_20', 'template_21', 'template_25'].includes(templateType),
        second: ['template_1', 'template_2', 'template_17', 'template_19'].includes(templateType),
    };
