...
export const contentContainerStyle = (elementId, attributes, data) => {
    ...
    if (isNotEmpty(attributes['contentAlignSecond'])) {
        data.push({
            'type': 'plain',
            'responsive': true,
            'id': 'contentAlignSecond',
            'selector': [
                `.${elementId} .gvnews_postblock ${secondThumbnailClass} .gvnews_postblock_content`,
                `.${elementId} .gvnews_postblock ${secondThumbnailClass} .gvnews_postblock_heading`
            ],
            'properties': [
                {
                    'name': 'text-align',
    ...
    if (isNotEmpty(attributes['contentContainerBackgroundSecond'])) {
        if (attributes['contentContainerBackgroundSecond']?.color || attributes['contentContainerBackgroundSecond']?.gradient) {
            data.push({
                'type': 'plain',
