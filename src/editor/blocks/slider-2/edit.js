...
const Slider2Block = compose(
    ...
    function RenderColumn(props) {
        ...
        return (
            <div className="gvnews_slider_type_2 gvnews_slider" data-autoplay={autoplay ? true : ''} data-delay={autoplayDelay}>
                {content}
            </div>
        );
    }
    ...
    function resetblock() {
        setBlock(
            <div className={`gvnews_slider_wrapper gvnews_slider_type_2_wrapper ${overlayOption == 'no' ? 'no-overlay' : ''}`}>
