...
const Slider5Block = compose(
    ...
    function RenderColumn(props) {
        ...
        return (
            <div className="gvnews_slider_type_5 gvnews_slider" data-autoplay={autoplay ? true : ''} data-delay={autoplayDelay}>
                {content}
            </div>
        );
    }
    ...
    function resetblock() {
        setBlock(
            <div className={`gvnews_slider_wrapper gvnews_slider_type_5_wrapper ${overlayOption == 'no' ? 'no-overlay' : ''}`}>
