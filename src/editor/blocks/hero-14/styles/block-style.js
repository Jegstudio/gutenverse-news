...
const getBlockStyle = (elementId, attributes) => {
    ...
    data = getContentStyle(elementId, attributes, data, 'Right');
    data = getContentStyle(elementId, attributes, data, 'Left');
    data = getContentStyle(elementId, attributes, data, 'Center');
...
const getContentStyle = (elementId, attribute, data, position) => {
    isNotEmpty(attribute[`titleTypography${position}`]) && data.push({
        'id': `titleTypography${position}`,
        'type': 'typography',
        'selector': `.gvnews-block.gvnews-block-wrapper.${elementId}  .${position.toLowerCase()} .gvnews_postblock_content .gvnews_post_title`,
    });
    isNotEmpty(attribute[`metaTypography${position}`]) && data.push({
        'id': `metaTypography${position}`,
        'type': 'typography',
        'selector': `.gvnews-block.gvnews-block-wrapper.${elementId}  .${position.toLowerCase()} .gvnews_postblock_content .gvnews_post_meta`,
    });
    isNotEmpty(attribute[`titleColor${position}`]) && data.push({
        'id': `titleColor${position}`,
        'type': 'color',
        'selector': `.gvnews-block.gvnews-block-wrapper.${elementId}  .${position.toLowerCase()} .gvnews_postblock_content .gvnews_post_title a`,
        'properties': [
            {
                'name': 'color',
                'valueType': 'direct'
    ...
    isNotEmpty(attribute[`titleColorHover${position}`]) && data.push({
        'id': `titleColorHover${position}`,
        'type': 'color',
        'selector': `.gvnews-block.gvnews-block-wrapper.${elementId}  .${position.toLowerCase()} .gvnews_postblock_content .gvnews_post_title:hover a`,
        'properties': [
            {
                'name': 'color',
                'valueType': 'direct'
    ...
    isNotEmpty(attribute[`metaColor${position}`]) && data.push({
        'id': `metaColor${position}`,
        'type': 'color',
        'selector': `.gvnews-block.gvnews-block-wrapper.${elementId}  .${position.toLowerCase()} .gvnews_postblock_content .gvnews_post_meta a`,
        'properties': [
            {
                'name': 'color',
                'valueType': 'direct'
    ...
    isNotEmpty(attribute[`excerptColor${position}`]) && data.push({
        'id': `excerptColor${position}`,
        'type': 'color',
        'selector': `.gvnews-block.gvnews-block-wrapper.${elementId} .${position.toLowerCase()} .gvnews_postblock_content .gvnews_post_excerpt p`,
        'properties': [
            {
                'name': 'color',
                'valueType': 'direct'
