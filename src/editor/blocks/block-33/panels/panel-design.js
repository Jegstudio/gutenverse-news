...
export const designPanel = (props) => {
    ...
    return [
        ...
        },
        {
            ...
            style: [
                {
                    selector: `.editor-styles-wrapper .wp-block .${elementId} .gvnews_post_title a`,
                    hasChild: true,
        ...
        },
        {
            ...
            style: [
                {
                    selector: [`.editor-styles-wrapper .wp-block .${elementId} .gvnews_post_excerpt p`, `.editor-styles-wrapper .wp-block .${elementId} .gvnews_post_excerpt .gvnews_readmore`],
                    hasChild: true,
                    render: (value,id) => handleTypography(value, props, id)
                }
            ]
        },
        {
            ...
            style: [
                {
                    selector: [`.${elementId} .gvnews_postblock .box_wrap`],
        ...
        {
            id: 'bgColorRead',
            label: __('Readmore Button Background', 'gutenverse-news'),
            component: ColorControl,
            style: [
                {
                    selector: [`.editor-styles-wrapper .wp-block .${elementId} .gvnews_postblock_33 .gvnews_readmore`],
                    render: value => handleColor(value, 'background')
                }
            ],
        },
        ...
        },
        {
            ...
            style: [
                {
                    selector: [`.editor-styles-wrapper .wp-block .${elementId} .gvnews_meta_author a`, `.editor-styles-wrapper .wp-block .${elementId} .gvnews_post_title a:hover`],
                    render: value => handleColor(value, 'color')
                }
            ],
        },
        ...
        },
        {
            ...
            style: [
                {
                    selector: [`.editor-styles-wrapper .wp-block .${elementId} .gvnews_post_excerpt`],
                    render: value => handleColor(value, 'color')
                }
            ],
        },
