...
const inputStyle = (elementId, attributes, data) => {
    ...
    isNotEmpty(attributes['inputColorFocus']) && data.push({
        ...
        'responsive': true,
        'selector': `
                    .${elementId} .comment-form input:not([type=submit]):focus, 
                    .${elementId} .comment-form textarea:focus, 
                    .${elementId} .comment-form input:not([type=submit]):focus-visible, 
                    .${elementId} .comment-form textarea:focus-visible
                    `,
        'properties': [
            {
                'name': 'color',
