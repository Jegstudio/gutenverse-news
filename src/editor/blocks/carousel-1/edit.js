...
const Carousel1Block = compose(
    ...
    function resetblock() {
        ...
        if(postData.length > 0) {
            setBlock(
                <div key={Math.random().toString(36).substring(2)} className={`gvnews_postblock_carousel gvnews_postblock_carousel_1 gvnews_postblock  gvnews_col_${blockWidth == 4 ? '1' : blockWidth == 8 ? '2' : '3'}o3`}>
