            ...
            setContent(authorData.map((author, index) => {
                const metas = author.meta ? author.meta.map((meta, key) => {
                    ...
                    <a href="#" onClick={(e) => e.preventDefault()} className="url">
                        {renderIcon('fas fa-globe', 'svg', btoa(globeSVG))}
                    </a>
                );
                return (
