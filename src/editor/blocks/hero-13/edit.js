...
const Hero13Block = compose(
    ...
    const blockProps = useBlockProps({
        className: classnames('gvnews-block',
            'gvnews-block-wrapper', 'gvnews-hero-9', elementId, animationClass, displayClass),
        ref: elementRef,
    });
