        ...
        <div {...blockProps}>
            <div className={`gvnews_navigation gvnews_pagination gvnews_col_3o3 gvnews_page${paginationMode} gvnews_align${paginationAlign} ${!paginationNavtext && 'no_navtext'} ${!paginationPageinfo && 'no_pageinfo'}`}>
                ...
                <div className="nav-wrapper">
                    {!isNav3 && <a className="nav-item page_nav prev" data-id="2" href="javascript:void(0);">{renderIcon('fas fa-angle-left', 'svg', btoa(prevIcon))}<span className="navtext">{paginationPrevText}</span></a>}
                    ...
                    {!isNav3 && <a className="nav-item page_nav next" data-id="2" href="javascript:void(0);"><span className="navtext">{paginationNextText}</span>{renderIcon('fas fa-angle-right', 'svg', btoa(nextIcon))}</a>}
                </div>
