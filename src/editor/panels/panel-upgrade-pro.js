            ...
            <div className="gutenverse-panel-wrapper" >
                <div className="deprecated-blocks-panel">
                    ...
                    <div className="deprecated-desc">
                        ...
                        <a target="_blank" rel="noreferrer" href={`${upgradeProUrl}?utm_source=gutenverse-news&utm_medium=blockProNotice&utm_client_site=${clientUrl}&utm_client_theme=${activeTheme}`} >Upgrade to Pro</a>
                    </div>
                </div>
            </div>
