...
export const ContentV300 = () => {
    ...
    return (
        <>
            ...
            <p className="update-desc">In this version, we are making major changes, including the deprecating several blocks and options, renaming blocks, and fixing a bug.</p>
            <ol>
                ...
                <p>The block are not completly removed, you can still access them, but you cannot create a new one or edit the deprecated block. If you believe in plugin worthiness, we’d greatly appreciate your support by upgrading to the Pro version.</p>
